...
type Props = {
  ...
  enviando: boolean
  error: string | null
  onEnviar: (datos: DatosCheckout) => void
  onVolver: () => void
}
  ...
  return (
    <>
      ...
      <div className="border-t border-gray-100 p-4 flex flex-col gap-3">
        ...
        {error && (
          <p className="text-xs text-center text-red-600 bg-red-50 border border-red-100 rounded-xl px-3 py-2">
            {error}
          </p>
        )}
        ...
        <button
          ...
          disabled={enviando}
          className="w-full bg-[#25D366] hover:bg-[#20bd5a] active:bg-[#1da851] disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold py-3.5 rounded-2xl flex items-center justify-center gap-2 transition-colors shadow-lg shadow-green-500/20 disabled:shadow-none"
        >
